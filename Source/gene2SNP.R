...
save(snptogene.ensembl,file="Data/SNPtoGene.RData")
...
save(genes.ensembl.hgnc,file="Data/GenesEnsemblHGNC.RData")
...
save(leadSNP005.gene,file="Data/leadSNP005Gene.RData")